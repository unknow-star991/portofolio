  ...
  return (
    <>
      ...
      >
        ...
        {/* MUSIC PLAYER */}
        <div className="fixed bottom-6 right-6 z-50 bg-black/40 backdrop-blur-2xl border border-white/10 p-4 rounded-3xl shadow-2xl">
          <p className="text-sm mb-3 text-zinc-300">
            Upload Music
          </p>

          <label className="cursor-pointer px-4 py-2 rounded-full bg-white text-black text-sm font-semibold hover:scale-105 transition inline-block mb-4">
            Choose Music
